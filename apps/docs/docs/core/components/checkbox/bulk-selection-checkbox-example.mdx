...
The field is validated using Yup and defined in BulkSelection config variable. Check [Validation Rules](/core-docs/configuration#validation-rules) for more detail.
