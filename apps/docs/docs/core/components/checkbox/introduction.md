...
[Checkbox](/core-docs/category/checkbox) give users binary choices when presented with multiple options in a series.
...
To make it a checkbox, use type: `InputTypes.CHECKBOX`. Check [Configuration](/core-docs/configuration#fieldtype-structure) to see what we can pass.
