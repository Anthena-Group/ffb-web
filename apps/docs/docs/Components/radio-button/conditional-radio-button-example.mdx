...
The field is validated using Yup and defined in conditionalRadio config variable. Check [Validation Rules](/docs/getting-started/my-doc-configuration#validation-rules) for more detail.
